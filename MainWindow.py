...
"*/")
        ...
        self.show_all_button = QtWidgets.QPushButton(self.frame_top_left)
        self.show_all_button.setMinimumSize(QtCore.QSize(40, 40))
        self.show_all_button.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.help = QtWidgets.QPushButton(self.frame_top_left)
        self.help.setMinimumSize(QtCore.QSize(40, 40))
        self.help.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.setting = QtWidgets.QPushButton(self.frame_top_left)
        self.setting.setMinimumSize(QtCore.QSize(40, 40))
        self.setting.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.update = QtWidgets.QPushButton(self.frame_top_left)
        self.update.setMinimumSize(QtCore.QSize(40, 40))
        self.update.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.index_button = QtWidgets.QPushButton(self.frame_top_left)
        self.index_button.setMinimumSize(QtCore.QSize(40, 40))
        self.index_button.setMaximumSize(QtCore.QSize(45, 45))
        ...
        self.text_scale_up = QtWidgets.QPushButton(self.frame_top_left)
        self.text_scale_up.setMinimumSize(QtCore.QSize(40, 40))
        self.text_scale_up.setMaximumSize(QtCore.QSize(45, 45))
        self.text_scale_up.setToolTipDuration(1000)
        self.text_scale_up.setStyleSheet("")
        self.text_scale_up.setText("")
        icon5 = QtGui.QIcon()
        ...
        self.text_scale_down = QtWidgets.QPushButton(self.frame_top_left)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.text_scale_down.setMinimumSize(QtCore.QSize(40, 40))
        self.text_scale_down.setMaximumSize(QtCore.QSize(45, 45))
        self.text_scale_down.setToolTipDuration(1000)
        self.text_scale_down.setStyleSheet("")
        self.text_scale_down.setText("")
        icon6 = QtGui.QIcon()
        ...
        self.text_scale_down.setAutoDefault(False)
        self.text_scale_down.setDefault(False)
        self.text_scale_down.setFlat(False)
