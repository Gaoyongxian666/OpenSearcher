...
class SearchThread(QThread):
    ...
    def run(self):
        ...
        for dir_path in self.DirPaths:
            self.file_name_lists.extend(file_name_list(dir_path=dir_path, types=self.types, icon_dir=self.icon_dir,
                                                       size_limit=self._limit_file_size, exclude=self._exclude_dir))
