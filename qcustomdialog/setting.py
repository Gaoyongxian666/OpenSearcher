...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_last_screen = QtWidgets.QCheckBox(self.frame_6)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.checkBox_last_screen.setFont(font)
        self.checkBox_last_screen.setObjectName("checkBox_last_screen")
        self.horizontalLayout_7.addWidget(self.checkBox_last_screen)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_last_screen.setText(_translate("MainWindow", "是否记住上次搜索时的文件类型"))
